...
public:
    SceneRunner(const std::string & windowTitle, int width = WIN_WIDTH, int height = WIN_HEIGHT, int samples = 0) : debug(true), lastWindowWidth(width), lastWindowHeight(height) {
        // Initialize GLFW
        ...
        // Get actual window size for rendering (matches window size)
